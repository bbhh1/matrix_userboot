...
R = [
    ...
    "**-** مطور السورس **⪼ [𐇮 𓂐 𓆩امير𓆪 𖠛🇾🇪🇺 ](t.me/amiraikb)   \n"
    "**-** قناة السورس **⪼ [𐇮 سيرثون العربي ](t.me/aaddr2)   "
]
...
Citation1_morning = [
    ...
    "** كت تويت | بعد ١٠ سنين ايش تصير ؟ **",
    "** كت تويت ‏| مِن أغرب وأجمل الأسماء التي مرت عليك؟ **",
    "** كت تويت | عمرك شلت مصيبة عن شخص برغبتك ؟ **",
    "** كت تويت | أكثر سؤال وجِّه إليك مؤخرًا؟ **",
    "** كت تويت | ما هو الشيء الذي يجعلك تشعر بالخوف؟ **",
    "** كت تويت | ايش الي يفسد الصداقة؟ **",
    ...
    "** كت تويت | ايش محتاج حتى تكون مبسوط ؟ **",
    "** كت تويت | مطلبك الوحيد الحين ؟ **",
    "** كت تويت | هل حدث وشعرت بأنك ارتكبت أحد الذنوب أثناء الصيام؟ **",
    "** كت تويت | اكثر مطور تحبه سيرثون امير منو ؟ **",
...
Jepthon_5erok = [
    ...
    "** لو خيروك |  بين رجل صنعاني أو ضالعي؟ **",
...
Jepthon_Shnow = [
    ...
    "** قسم بالله والانجيل والتوراة هذا ينيج 😹 **",
...
Jepthon_Bosa = [
    ...
    "** امممممح احبك موت عليش انتي عسلل 😻 **",
    "** ويييع شبوس منه غير ريحة لقفه تكتل 🤮 **",
